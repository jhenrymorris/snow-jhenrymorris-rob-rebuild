...
return gs.getUser().hasAssignedRole('x_2166123_rob_auth.rob_admin') ||
    ...
    current.getValue('x_2166123_rob_auth_supervisor_snapshot') == userId;`

Acl({
    $id: Now.ID['payroll-requested-items-write'],
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_requested_items',
    operation: 'write',
    decisionType: 'allow',
    script: 'return false;',
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_position_title',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_supervisor_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_exception_review_required',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_exception_reason',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_authorization_processing_blocked',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_requires_employee_signature',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_requires_supervisor_signature',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_fulfillment_gate_complete',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_snapshot_correction_requested',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_prior_position_title',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_prior_supervisor_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_snapshot_corrected_by',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_snapshot_corrected_at',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_snapshot_correction_reason',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    field: 'x_2166123_rob_auth_rob_task_type',
    operation: 'write',
    decisionType: 'allow',
    script: 'return false;',
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_organization_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_rob_auth_prior_organization_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
