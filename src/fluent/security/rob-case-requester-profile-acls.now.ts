...
return gs.getUser().hasAssignedRole('x_2166123_hr_acc_0.rob_admin') ||
    gs.getUser().hasAssignedRole('x_2166123_hr_acc_0.rob_compliance_viewer') ||
    isSelfSubmittingSubject ||
    current.getValue('x_2166123_hr_acc_0_supervisor_snapshot') == userId;`

Acl({
    $id: Now.ID['payroll-requested-items-write'],
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_requested_items',
    operation: 'write',
    decisionType: 'allow',
    script: 'return false;',
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_position_title',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_supervisor_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_exception_review_required',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_exception_reason',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_authorization_processing_blocked',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_requires_employee_signature',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_requires_supervisor_signature',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_fulfillment_gate_complete',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_snapshot_correction_requested',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_prior_position_title',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_prior_supervisor_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_snapshot_corrected_by',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_snapshot_corrected_at',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_snapshot_correction_reason',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    field: 'x_2166123_hr_acc_0_rob_task_type',
    operation: 'write',
    decisionType: 'allow',
    script: 'return false;',
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_organization_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
...
Acl({
    ...
    type: 'record',
    table: 'sn_hr_core_case_payroll',
    field: 'x_2166123_hr_acc_0_prior_organization_snapshot',
    operation: 'write',
    decisionType: 'allow',
    roles: [robAdminRole],
    adminOverrides: false,
