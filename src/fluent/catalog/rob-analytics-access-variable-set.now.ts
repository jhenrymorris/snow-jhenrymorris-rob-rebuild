...
import { x_2166123_rob_auth_rob_access } from '../tables/rob-access-item-reference.now'
...
export const robAnalyticsAccessVariableSet = VariableSet({
    ...
    order: 300,
    variables: {
        x_2166123_rob_auth_requested_items: ListCollectorVariable({
            question: 'Requested Access Items',
            listTable: x_2166123_rob_auth_rob_access.name,
            referenceQual:
        ...
        x_2166123_rob_auth_operations_manager: ReferenceVariable({
