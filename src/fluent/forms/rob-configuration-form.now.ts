...
export const robConfigurationForm = Form({
    ...
    sections: [
        ...
        { caption: 'Profile and Context Policy', content: [{ layout: 'two-column', leftElements: [{ field: 'approved_supervisors_group', type: 'table_field' }, { field: 'approved_organization_root', type: 'table_field' }], rightElements: [{ field: 'allow_sys_user_title_fallback', type: 'table_field' }] }] },
