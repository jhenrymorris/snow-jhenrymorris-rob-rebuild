...
export const robAuthorizationForm = Form({
    table: 'x_2108496_hr_acces_rob_auth', view: default_view,
    roles: [robAdminRole, robComplianceViewerRole],
    sections: [
        { caption: 'Subject and Employment', content: [{ layout: 'two-column', leftElements: [
        ...
        { caption: 'Authorization Scope', content: [
            { layout: 'two-column', leftElements: [{ field: 'number', type: 'table_field' }, { field: 'authorization_action', type: 'table_field' }], rightElements: [{ field: 'source_hrsd_case', type: 'table_field' }] },
            { layout: 'one-column', elements: [{ field: 'business_justification', type: 'table_field' }] },
        ] },
        ...
        { caption: 'Supervisor Approval and Signature Evidence', content: [{ layout: 'two-column', leftElements: [
        ...
        { caption: 'Reminder and Lapse History', content: [{ layout: 'two-column', leftElements: [
        ...
        { caption: 'Authorized Access Details', content: [{ layout: 'one-column', elements: [{
            type: 'list', listType: '12M', listRef: 'x_2108496_hr_acces_auth_detail.rob_authorization_form',
        }] }] },
    ],
})
