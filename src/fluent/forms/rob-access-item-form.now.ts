...
export const robAccessItemForm = Form({
    ...
    sections: [
        ...
        { caption: 'External Systems', content: [{ layout: 'two-column', leftElements: [{ field: 'external_provisioning_system', type: 'table_field' }], rightElements: [{ field: 'external_target_system', type: 'table_field' }] }] },
